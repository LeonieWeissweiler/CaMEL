...
user_path = '/mounts/work/weissweiler/deepcase/final_data/spacy_3.0_lg/'
...
spacy_engine = spacy.load('en_core_web_lg')
...
def process_verse(verse_num):
    ...
    for eng_edition in eng_editions:
        ...
        doc = spacy_engine(eng_text)
        eng_docs[eng_edition] = doc
